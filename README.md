    ...
    <table align="center" border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
            ...
            <td style="border: 1px solid #ddd; vertical-align: top;">
                ...
                TP1: Proporcioné liderazgo conjunto ya que entre todos pudimos avanzando aspectos claves del proyecto, como el mercado del startup y estrategias frente a competidores.<br><br>
                TB2: Proporcioné liderazgo conjunto al ver las heurísticas del proyecto, ya que se pudo observar que aspectos se necesitan mejorar y así coordinar con el grupo estas mejoras.<br><br>
                ...
                TP1: Colaboré en reuniones para acordar temas claves del proyecto, así aplicando liderazgo conjunto.<br><br>
                ...
                TP1: Proporcioné liderazgo conjunto al colaborar coordinando con mis team members en la planificación del sprint backlog, así facilitanto la organización de tareas para cada uno, como para distribuir las funciones del front-end.<br><br>
                TB2: Proporcioné liderazgo conjunto al coordinar al equipo en la implementación del backend y en la organización del diseño de entrevistas de validación, asignando tareas para el desarrollo de servicios y definición de endpoints.<br><br>
                TF1: Trabajé en equipo conociendo la importancia de los nuevos sprint goals y la integración del bounded context IAM en el backend, asegurando que todos comprendieran los cambios y su impacto en la arquitectura del sistema.<br><br>
                ...
                TP1: Colaboré de manera proactiva en las reuniones grupales hechas para realizar el proyecto, para distribuirnos las funciones equitativamente. De esta forma se logró entregar un buen trabajo para el front-end con la coordinación conjunta de todos los miembros. <br><br>
                TB2: Colaboré de manera proactiva con los miembros del equipo, también ayudando con el diseño de entrevistas, para que de esta forma, todos los que realizamos las entrevistas pudieramos estar alineados.<br><br>
                TF1: Trabajé en equipo gracias a los avances de la implementación del backend y la creación de usuarios de prueba, explicando al equipo y al docente cómo probar el login y la integración de los diferentes roles.<br><br>
                ...
                TP1: Colaboré en las reuniones realizadas para tener una buena coordinacion para implementar las funciones necesarias en el Front-End. Ademas de un desarrollo colaborativo de la landing page, asi como el despliegue de la landing page, donde la adecuada distribucion de las secciones nos permitio resolver facilmente conflictos. <br><br>
                TB2: Colaboré realizar las entrevistas, así como el análisis de estas para que todos podamos aplicar las mejores que nuestros segmentos objetivos sugirieron, de estar forma aplicando liderazgo conjunto. <br><br>
                TF1: Trabajé en equipo gracias a las correcciones realizadas en el backend, asegurando que todos comprendieran los cambios en los tipos de usuario y planes, y coordiné la integración de mi sección con el resto del proyecto.<br><br>
        </td>
        <td style="border: 1px solid #ddd; vertical-align: top;">El equipo demostró un efectivo liderazgo conjunto durante el TF1, donde cada miembro asumió responsabilidades compartidas de coordinación y toma de decisiones. Se evidenció una colaboración fluida que abarcó desde aspectos estratégicos y técnicos del proyecto hasta la planificación operativa y distribución de tareas. La comunicación continua, las reuniones regulares y el trabajo colaborativo en el desarrollo de componentes clave como wireframes, mockups, database diagrams y landing page fueron fundamentales. El compromiso colectivo por mantener una sana relación de equipo y la capacidad para resolver conflictos de manera conjunta permitieron lograr consensos efectivos y entregar un trabajo cohesivo y de calidad, demostrando que el liderazgo fue verdaderamente compartido y distribuido entre todos los integrantes.</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; vertical-align: top;">
            ...
            <td style="border: 1px solid #ddd; vertical-align: top;">
                ...
                TP1: Fomenté un entorno colaborativo e inclusivo al reunir al equipo para definir juntos las metas del análisis de mercado del startup y las estrategias frente a competidores, asignando tareas específicas de investigación y asegurando que cada voz aportara ideas y compromisos claros con los objetivos acordados.<br><br>
                TB2: Creé un ambiente participativo al coordinar la revisión heurística del proyecto, estableciendo metas de mejora, distribuyendo las tareas de evaluación y corrección entre todos los miembros del grupo, y haciendo seguimiento diario para garantizar el cumplimiento puntual de los objetivos.<br><br>
                <strong>Joseph Chavez</strong><br>
                ...
                TP1: Colaboré en reuniones para acordar temas claves del proyecto, así aplicando trabajo colaborativo. <br><br>
                <strong>Adrian Donayre</strong><br>
                ...
                TP1: Fomenté un entorno colaborativo e inclusivo al coordinar la planificación del sprint backlog, distribuyendo equitativamente las tareas de front-end entre los miembros y asegurando que cada uno entendiera sus responsabilidades y objetivos.<br><br>
                TB2: Proporcioné liderazgo conjunto al organizar la implementación del backend y el diseño de entrevistas de validación, asignando roles claros, estableciendo metas de entrega y realizando seguimientos diarios para garantizar el cumplimiento de los objetivos.<br><br>
                TF1: Creé un entorno colaborativo efectivamente con diferentes audiencias al documentar entrevistas adaptando el registro según el usuario, redactar user stories en formato comprensible para técnicos y no técnicos, crear descripciones claras de la startup para diferentes stakeholders, documentar wireframes con anotaciones precisas y elaborar el product backlog con especificaciones detalladas para el equipo de desarrollo. <br><br>
                <strong>Christian Inga</strong><br>
                TB1:
                ...
                <br><br>
                TP1: Promoví la colaboración al facilitar reuniones grupales en las que definimos y asignamos de manera equitativa las funciones de front-end, estableciendo metas claras y fomentando la participación de todos los integrantes.
                <br><br>
                TB2: Colaboré en la organización del diseño de entrevistas de validación, definiendo tareas específicas para cada miembro, planificando plazos y coordinando revisiones para mantener al equipo alineado y cumplir los objetivos.
                <br><br>
                TF1: Planifiqué tareas por escrito efectivamente con la implementación de mi sección del backend y la creación de usuarios de prueba, detallando el proceso para que el docente pudiera probar el login y la funcionalidad de los diferentes roles. <br><br>
                <strong>Carlos Fernandez</strong><br>
                TB1: Colabore y apoye en la inclusion de todos los integrantes para un mejor avance, asi como el establecimiento de fechas de manera organizada para evitar problemas de entrega o complicaciones, las cuales serian resultas entre varios integrantes, con el desarollo de las User Stories comprendi a mayor alcance las capacidades del equipo, ademas de otros elementos que nos permitiron conocer sobre nuestros segmentos objetivos y contribuir en la investigacion grupal del tema. Asimismo coordine adecuadamente el diseño de landing page y app web, donde los wireframes y mock up tuvieron la aprobacion del equipo.<br><br>
                TP1: Impulsé un ambiente de trabajo inclusivo al liderar reuniones de coordinación para implementar las funcionalidades de front-end y desplegar la landing page, fijando metas concretas y distribuyendo las tareas de forma clara.<br><br>
                TB2: Coordiné la realización y el análisis de entrevistas de validación, asignando responsabilidades, diseñando el cronograma de actividades y verificando el avance para asegurar que las mejoras sugeridas por los usuarios se aplicaran efectivamente.<br><br>
                TF1: Planifiqué tareas corrigiendo incongruencias entre los usuarios y planes disponibles, y asegurando la integración adecuada con el resto del proyecto. <br><br>
        </td>
...
![image](public/assets/images/MobileWireframes/Signup.png)
 ...
 **Register Mobile Mockups and Tools**
 ...
 ![image](public/assets/images/MobileMockups/Signin.png)
 ...
 **Cupping Mockups**
 ...
 ![image](public/assets/images/MobileMockups/Defect.png)
...
|----------------------|----------------------------|----------------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| **SensoryEvaluation**| Sensory Evaluation         | Entity               | Represents a sensory evaluation (tasting) of a roasted coffee lot                             | - lotId: String<br>- roastSessionId: String<br>- attributes: Map of String to Float<br>- scores: Map of String to Float<br>- timestamp: DateTime<br>- compare(other: SensoryEvaluation) | generateProfile()                                | - 0..* to 1 CoffeeLot: evaluated in<br>- 0..* to 1 RoastSession: evaluated in                                                                     |
| **Recipe**           | Preparation Entity         | Entity               | Represents a coffee preparation recipe                                                        | - id: String<br>- userId: String<br>- name: String<br>- method: String<br>- ratio: Float<br>- temperature: Float<br>- time: Float<br>- grindSetting: String<br>- lotId: String<br>- permissions: List of String<br>- shareWithTeam(permissions: List of String)<br>- suggestImprovement(changes: String) | None                                            | - 0..* to 1 User: created by<br>- 0..* to 1 CoffeeLot: associated with                                                                            |
| **GrindCalibration** | Preparation Entity         | Entity               | Represents a grind calibration for coffee preparation                                         | - id: String<br>- userId: String<br>- equipment: String<br>- grindSetting: String<br>- timestamp: DateTime<br>- image: String<br>- extractionTime: Float<br>- compareWith(other: GrindCalibration) | None                                            | - 0..* to 1 User: documented<br>- 0..* to 1 Beverage: prepared with                                                                                |
| **Beverage**         | Preparation Entity         | Entity               | Represents a beverage created by a user in their portfolio                                    | - id: String<br>- userId: String<br>- name: String<br>- category: String<br>- ingredients: List of String<br>- method: String<br>- grindSetting: String<br>- photo: String<br>- categorize(category: String) | None                                            | - 0..* to 1 User: created                                                                                                                          |
| **Inventory**        | Administration Entity      | Entity               | Represents the inventory of green and roasted coffee                                          | - id: String<br>- items: Map of CoffeeLot to Float<br>- movements: List of Movement<br>- alerts: List of String<br>- updateStock(lot: CoffeeLot, quantity: Float)<br>- generateAlert() | None                                            | - 1 to 0..* CoffeeLot: tracked<br>- 1 to 0..* Movement: has                                                                                        |
| **Movement**         | Administration Value Object| Value Object         | Represents an inventory movement (addition or subtraction)                                    | - id: String<br>- quantity: Float<br>- timestamp: DateTime<br>- type: String                     | None                                            | - 0..* to 1 Inventory: belongs to                                                                                                                   |
| **Cost**             | Administration Entity      | Entity               | Represents the cost structure associated with a coffee lot                                    | - id: String<br>- lotId: String<br>- categories: Map of String to Float<br>- totalCost: Float<br>- totalKg: Float<br>- costPerKg: Float              | None                                            | - 0..1 to 1 CoffeeLot: affects                                                                                                                     |
| **PerformanceAnalysis**| Administration Entity    | Entity               | Represents the performance analysis of a coffee lot production process                        | - id: String<br>- lotId: String<br>- margin: Float<br>- metrics: Map of String to Float<br>- compareWith(other: PerformanceAnalysis) | calculateMetrics()                             | - 0..1 to 1 CoffeeLot: associated with                                                                                                             |
| **TraceabilityReport**| Administration Entity     | Entity               | Represents a traceability report for a coffee lot                                             | - id: String<br>- lotId: String<br>- chainDetails: String                                        | None                                            | - 0..1 to 1 CoffeeLot: associated with                                                                                                             |
| **ContactForm**      | Landing Page Entity        | Entity               | Represents a contact form submission from the landing page                                    | - name: String<br>- email: String<br>- message: String<br>- timestamp: DateTime                 | sendConfirmation() (None, standalone entity)    | None                                                                                                                                                 |
...
Link de [Trello](public\assets\images\Trello\trello.png)
...
**US12:**
![image](public\assets\images\WebAppEvidences\US-12.png)  
![image](public\assets\images\WebAppEvidences\US-12-1.png)
